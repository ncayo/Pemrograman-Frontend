...
const users = [
  ...
  {nama : "Nurul", age : "24", Major : "System Informatics"},
  {nama : "Jundi", age : "20", Major : "Finance"},
  {nama : "Cahyo", age : "19", Major : "Informatics"}
]
...
const all = () => {
  for(const user of users){
    console.log(`nama :${user.nama}, age : ${user.age}, Major : ${user.Major}`);
  } 
}
